...
#define TSDB_CODE_MND_XNODE_INVALID_ALGO_TYPE   TAOS_DEF_ERROR_CODE(0, 0x0465)
#define TSDB_CODE_MND_XNODE_TOO_MANY_ALGO       TAOS_DEF_ERROR_CODE(0, 0x0466)
#define TSDB_CODE_MND_XNODE_TOO_LONG_ALGO_NAME  TAOS_DEF_ERROR_CODE(0, 0x0467)
#define TSDB_CODE_MND_XNODE_TOO_MANY_ALGO_TYPE  TAOS_DEF_ERROR_CODE(0, 0x0468)
...
#define TSDB_CODE_GRANT_LACK_OF_TA_BASIC        TAOS_DEF_ERROR_CODE(0, 0x0831)
