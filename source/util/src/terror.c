...
TAOS_DEFINE_ERROR(TSDB_CODE_MND_XNODE_INVALID_ALGO_TYPE,  "Xnode invalid algorithm type")
TAOS_DEFINE_ERROR(TSDB_CODE_MND_XNODE_INVALID_VERSION,    "Xnode invalid version")
TAOS_DEFINE_ERROR(TSDB_CODE_MND_XNODE_TOO_MANY_ALGO,      "Xnode too many algorithm")
TAOS_DEFINE_ERROR(TSDB_CODE_MND_XNODE_TOO_LONG_ALGO_NAME, "Xnode too long algorithm name")
TAOS_DEFINE_ERROR(TSDB_CODE_MND_XNODE_TOO_MANY_ALGO_TYPE, "Xnode too many algorithm type")
